...
with DAG(
    ...
    def extract():
        ...
        try:
            # Query
            with open('include/3IUNJujuy.sql','r',encoding='utf-8') as f:
                sql_script = f.read()
            hook = PostgresHook(postgres_conn_id="alkemy_db")
            df = hook.get_pandas_df(sql=sql_script)
            df.to_csv("include/files/3IUNJujuy_select.csv")
    ...
    def transform():
        ...
        try:
            ...
            # DF Universidad
            with open("include/files/3IUNJujuy_select.csv") as f:
            ...
            # Created Files
            df.to_csv("include/files/3IUNJujuy_process.txt",sep="\t",index=None)
    ...
    def load():
        ...
        try:
            ...
            data = open("include/files/3IUNJujuy_process.txt", "rb")
